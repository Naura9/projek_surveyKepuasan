<?php
    ...
    $query_check_survey = "SELECT COUNT(*) AS jumlah_survey FROM t_jawaban_industri
                            ...
                            WHERE m_survey_soal.kategori_id = 4
    ...
    if(isset($_POST['simpan'])) {
        $nama = $_SESSION['nama']; 
        $query_responden = "SELECT responden_industri_id FROM t_responden_industri     
        JOIN m_survey ON m_survey.survey_id = t_responden_industri.survey_id
        JOIN m_user ON m_user.user_id = m_survey.user_id
        WHERE m_user.user_id = '$user_id'";
    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="popup-container">
                <p class="popupmessage">Survey Lulusan Telah Diisi</p>
