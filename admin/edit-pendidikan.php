        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['simpan'])) {
                ...
                if($stmt->affected_rows > 0) {
                    $_SESSION['success_message'] = "Pertanyaan dengan nama \"$soal_nama_lama\" berhasil diperbarui menjadi \"$soal_nama_baru\" untuk semua survey_id";
                } else {
                    $_SESSION['error_message'] = "Gagal memperbarui pertanyaan dengan nama \"$soal_nama_lama\"";
                }
