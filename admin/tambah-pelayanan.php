        ...
        if ($result_survey_ids) {
            while ($row_survey_id = mysqli_fetch_assoc($result_survey_ids)) {
                ...
                if ($stmt = $kon->prepare($sql)) {
                    ...
                    if ($stmt->execute()) {
                        $_SESSION['success_message'] =  "Pertanyaan pendidikan berhasil ditambahkan untuk survey_id: $survey_id <br>";
                    } else {
                        $_SESSION['error_message'] = "Gagal menambahkan pertanyaan pelayanan untuk survey_id: $survey_id <br>";
                    }
