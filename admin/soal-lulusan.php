        ...
        <?php
            ...
            foreach ($lulusan as $p) {
                ?>
                    ...
                    <form action="hapus-lulusan.php?id=<?php echo $p['soal_id']; ?>" method="post" id="hapusForm">
                        ...
                        <div class="pilihan-container">
                            ...
                            <div class="pilihan2">
                                ...
                                <a href="edit-lulusan.php?id=<?php echo $p['soal_id']; ?>" class="btn button-edit">Edit</a>
                            </div>
                        </div>
                        </form>
