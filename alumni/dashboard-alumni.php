<?php
    ...
    $query_get_responden_id = "SELECT responden_alumni_id FROM t_responden_alumni WHERE responden_nama = '$nama'";
    ...
    $query_jumlah_survey = "SELECT COUNT(DISTINCT m_survey_soal.kategori_id) AS jumlah_survey
                            ...
                            INNER JOIN m_survey_soal ON t_jawaban_alumni.soal_id = m_survey_soal.soal_id
                            WHERE t_jawaban_alumni.responden_alumni_id = '$responden_alumni_id'";
