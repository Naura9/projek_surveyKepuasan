...
<?php
    ...
    // Mendapatkan responden_dosen_id pengguna yang sedang login
...
<div class="container">
    ...
    <div class="content">
        ...
        <form method="post" action="jawaban-pendidikan-dosen.php">
        <?php
            $no = 1;
    ...
    function closePopup() {
        ...
        // Alihkan pengguna kembali ke dashboard-dosen setelah mengklik OK pada pesan pop-up
