<?php
    ...
    $query = "SELECT * FROM t_responden_dosen 
    ...
    if(mysqli_num_rows($res) > 0) {
        ...
        if(isset($_FILES["fileImg"]["name"])){ 
            ...
            $query = "UPDATE t_responden_dosen SET image = '$imageName' WHERE responden_dosen_id = $id"; 
                        ...
                        <table class="table">
                            <div class="form-group text-left font-weight-bold">
                                <div class="profile-label">Foto Profil</div>
                                    ...
                                    <input type="hidden" name="responden_dosen_id" value="<?php echo $dosen['responden_dosen_id']; ?>">
                                    <div class="upload">
                                    <div class="rightRound" id="upload">
                                            <input type="file" name="fileImg" id="fileImg" accept=".jpg, .jpeg, .png">
                                            <i class="fa fa-camera"></i>
                                        </div>
                                        <img src="img/<?php echo $dosen['image']; ?>" id="image">
                            ...
                            <form action="proses-edit.php" method="POST">
                                ...
                                <div class="form-group text-left font-weight-bold">
                                    ...
                                    <input type="text" class="form-control bg-custom" name="responden_nip" id="responden_nip" value="<?php echo $dosen['responden_nip']; ?>">
                                </div>					
                                <div class="form-group text-left font-weight-bold">
                                    <label for="respinden_nama">Nama Lengkap</label>
                                    <input type="text" class="form-control bg-custom" name="responden_nama" id="responden_nama" value="<?php echo $dosen['responden_nama']; ?>">
                                </div>						
                                <div class="form-group text-left font-weight-bold">
                                    <label for="username">Username</label>
                                    <input type="text" class="form-control bg-custom" name="username" id="username" value="<?php echo $dosen['username']; ?>">
                                </div>						
                                <div class="form-group text-left font-weight-bold">
                                ...
                                <div class="form-group text-left font-weight-bold">
                                    ...
                                    <input type="text" class="form-control bg-custom" name="email" id="email" value="<?php echo $dosen['email']; ?>">
                                </div>						
                                <div class="form-group text-left font-weight-bold">
                                    <label for="responden_unit">Unit</label>
                                    <input type="text" class="form-control bg-custom" name="responden_unit" id="responden_unit" value="<?php echo $dosen['responden_unit']; ?>">
                                </div>						
                            </div>					
                        </table>
                    </div>
