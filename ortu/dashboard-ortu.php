<?php
    ...
    $query_get_responden_id = "SELECT responden_ortu_id FROM t_responden_ortu WHERE responden_nama = '$nama'";
    ...
    $query_jumlah_survey = "SELECT COUNT(DISTINCT m_survey_soal.kategori_id) AS jumlah_survey
                            FROM t_jawaban_ortu
                            INNER JOIN m_survey_soal ON t_jawaban_ortu.soal_id = m_survey_soal.soal_id
                            WHERE t_jawaban_ortu.responden_ortu_id = '$responden_ortu_id'";
