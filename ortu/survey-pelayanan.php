<?php
    ...
    $query_check_survey = "SELECT COUNT(*) AS jumlah_survey FROM t_jawaban_ortu
                            ...
                            AND t_jawaban_ortu.responden_ortu_id = '$responden_ortu_id'";
    ...
    if(isset($_POST['simpan'])) {
        ...
        if(mysqli_num_rows($result_responden) > 0) {
            ...
            $responden_ortu_id = $data_responden['responden_ortu_id'];
        } else {
        ...
        while ($row = mysqli_fetch_assoc($result_soal_id)) {
            ...
            $query_insert_jawaban = "INSERT INTO t_jawaban_ortu (responden_ortu_id, soal_id, jawaban) 
                                     VALUES ('$responden_ortu_id', '$soal_id', '$jawaban')";
