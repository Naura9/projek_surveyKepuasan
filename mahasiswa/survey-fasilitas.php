<?php
    ...
    $query_get_responden_id = "SELECT responden_mahasiswa_id FROM t_responden_mahasiswa 
    ...
    if(isset($_POST['simpan'])) {
        $nama = $_SESSION['nama']; 
        $query_responden = "SELECT responden_mahasiswa_id FROM t_responden_mahasiswa     
        JOIN m_survey ON m_survey.survey_id = t_responden_mahasiswa.survey_id
        JOIN m_user ON m_user.user_id = m_survey.user_id
        WHERE m_user.user_id = '$user_id'";
