...
if(isset($_POST['simpan'])) {
    ...
    $query_responden = "SELECT responden_mahasiswa_id, survey_id FROM t_responden_mahasiswa WHERE responden_nama = '$nama'";
    ...
    if(mysqli_num_rows($result_responden) > 0) {
        ...
        $survey_id = $data_responden['survey_id'];
    ...
    AND m_survey.survey_id = '$survey_id'";
